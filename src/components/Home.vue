...
<!--        <span href="">HDU</span>-->
<!--        <span href="">概要</span>-->
<!--        <span href="">多源数据智能协同清洗系统</span>-->
<!--        <span href="">数据类型</span>-->
<!--      </div>-->

      <el-button type="info">多源数据智能协同清洗系统</el-button>
    </el-header>
<!--    主题区域-->
    <el-container>
<!--      侧边栏-->
...
<!--          菜单2-->
          <el-submenu index="2">
            ...
            <el-submenu index="2-1">
              ...
              <el-menu-item index="/sensor/temperature/sensor001">温度传感器001</el-menu-item>
              <el-menu-item index="/sensor/temperature/sensor002">温度传感器002</el-menu-item>
          ...
          <el-submenu index="3">
            ...
            <el-submenu index="3-1">
              ...
              <el-menu-item index="/camera/eastexitcamera">东大门出口</el-menu-item>
                <el-menu-item index="/camera/northcamera">北门口摄像头</el-menu-item>
            </el-submenu>
          </el-submenu>
          <el-submenu index="4">
            <!--              一级菜单的模板区域-->
